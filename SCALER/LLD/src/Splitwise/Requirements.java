...
public class Requirements {
    public static void main(String[] args){
        /* Design an online expense sharing application
        This time we have all the requirements with us, and we just need to implement it as per
        the requirements.
        ...
        5) To add an expense, a user must specify either the group, or the other users involved
        in the expense, along with who paid what and who owes what. They must also specify a
        ...
        12) Users can request a settle-up for any group they're participating in. The application should
        show a list of transactions, which, if executed, will ensure that everyone participating in the
        group is settled up (owes a net of 0 Rs). Note that will only deal with the expenses made inside
        that group. Expenses outside the group need not be settled. Good to Have Requirements

        13) When settling a group, we should try to minimize the number of transactions that the group
        ...
        These requirements are straight forward and nothing more to explain about it, and even if
        it feels like to be elaborated, spend some time with these statements, everything would be
        crystal clear.
        * */
    }
}
